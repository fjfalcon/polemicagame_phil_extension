...
> **Переезжаешь с временного дополнения на подписанное?** Сначала «Ещё» → «Экспорт»
> (бэкап настроек и заметок), потом установка `.xpi`, потом «Импорт». Для браузера это
> разные установки, данные сами не перейдут.
